const projects = [
  {
    ...
    featuredImageSource: './images/Icons/bg.jpg',
    featuredImageAlt: 'Project image',
    technology: ['css', 'html', 'bootstrap', 'Ruby'],
    demoLive: '',
    sourceLink: 'https://github.com/Obote/myportfolio',
  },
  {
    name: 'Multi-Post Stories',
    description:
...
function hideProject(prevProject) {
  ...
  if (prevProject.nextSibling) {
    prevProject.nextSibling.querySelector('.project-picture').style.filter = 'blur(0)';
  }
}
